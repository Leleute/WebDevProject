...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mer. 01 mai 2019 à 17:18
...
INSERT INTO `acheteur` (`ID`, `Nom`, `Prenom`, `Email`, `Login`, `Mdp`, `Adresse1`, `Adresse2`, `Ville`, `CodePostale`, `Pays`, `Tel`, `TypeCarte`, `NumCarte`, `NomCarte`, `DateExpi`, `CodeSecu`) VALUES
(1, 'Dupont', 'Nicolas', 'nicolas.dupont@gmail.com', 'Nico12', 'Nicooo', '13 avenue des peupliers', 'Pas', 'Antony', 92160, 'France', 645782347, 'Visa', '78624656652087214', 'Dupont Nicolas', '2024-02-09', 789),
(2, 'Forestu', 'Clara', 'clara.forestu@gmail.com', 'clara29', 'Clarafo', '5 avenue des roses', '', 'Paris 5eme arrondissement', 75005, 'France', 745761214, 'Visa', '78628648901757', 'Clara Forestu', '2020-05-29', 142),
(4, 'Leleu', 'Matthieu', 'matthieu.leleu@wanadoo.fr', 'Ml', 'azer', '12 rue Emilien Colin', 'sdfsdf', 'Suresnes', 92150, 'France', 637373737, 'Visa', '12', 'Leleu', '12-12-12', 232);
...
INSERT INTO `vendeur` (`ID`, `Pseudo`, `Email`, `PdP`, `PdC`, `Nom`, `mdp`) VALUES
(2, 'RoRO', 'romain@orange.fr', 'ppromain.jpg', 'Dupont_Nicolas.jpg', 'Romain', '75zone'),
(1, 'Lilia', 'lili@gmail.com', 'pplili.jpg', 'fondClara.jpg', 'Rimou', 'Liliaa45');
