...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mer. 01 mai 2019 à 09:23
...
CREATE TABLE IF NOT EXISTS `acheteur` (
  ...
  `AdresseFond` varchar(255) NOT NULL,
...
INSERT INTO `acheteur` (`ID`, `Nom`, `Prenom`, `AdressePhoto`, `Email`, `Login`, `Mdp`, `Adresse1`, `Adresse2`, `Ville`, `CodePostale`, `AdresseFond`, `Pays`, `Tel`, `TypeCarte`, `NumCarte`, `NomCarte`, `DateExpi`, `CodeSecu`) VALUES
(1, 'Dupont', 'Nicolas', 'Dupont_Nicolas.jpg', 'nicolas.dupont@gmail.com', 'Nico12', 'Nicooo', '13 avenue des peupliers', 'Pas', 'Antony', 92160, 'fondNicolas.jpg', 'France', 645782347, 'Visa', '78624656652087214', 'Dupont Nicolas', '2024-02-09', 789),
(2, 'Forestu', 'Clara', 'clara.jpg', 'clara.forestu@gmail.com', 'clara29', 'Clarafo', '5 avenue des roses', '', 'Paris 5eme arrondissement', 75005, 'fondClara.jpg', 'France', 745761214, 'Visa', '78628648901757', 'Clara Forestu', '2020-05-29', 142);
